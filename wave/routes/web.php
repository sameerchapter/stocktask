...
Route::group(['middleware' => 'wave'], function () {
	...
	Route::delete('stock', '\Wave\Http\Controllers\DashboardController@stockDelete')->name('stock.destroy');
	Route::get('stock_edit', '\Wave\Http\Controllers\DashboardController@stockEdit')->name('stock.edit');
	Route::post('stock_store', '\Wave\Http\Controllers\DashboardController@stockStore')->name('stock.store');
});

Route::get('store_data', '\Wave\Http\Controllers\DashboardController@store_stock');
